/*
 */
package dk.tv2.bulldog.backend.net;
...
public class HTTPRestClient {
    ...
    public InputStream download(String path) {
        try {
            ...
            if (responseCode > 399 && responseCode < 500) {
                // CLIENT ERROR 
                throw new Exception("Error in request response [" + responseCode + "]");
            }
    ...
    private String action(String method, String path, String data) {
        try {
            URL remoteURL = new URL(host + path);
            HttpURLConnection urlConnection = (HttpURLConnection) remoteURL.openConnection();
